...
export const metadata: Metadata = {
  ...
  description: "Urubugaa is your one-stop online marketplace to buy and sell products online. Sign up, or signin today and start shopping and selling easily and securely.",
  keywords: [
    "Urubugaa",
    "ecommerce Rwanda",
    "buy online Rwanda",
